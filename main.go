...
func main() {
	...
	fmt.Printf("%s has been started...\nMade with ❤️ by @P_4_PEEYUSH (@SharkModsOfficial).\n", b.User.Username)
...
func randomFormat() string {
	formats := []string{
		...
		"frouvuvullehi-5850@yopmail.net:PEEYUSH999@", 
		"graupousazeuhi-1136@yopmail.com:123456",
		"bhaiyaartum@yopmail.net:PEEYUSH999@",
...
func start(ctx *ext.Context) error {
	...
	MSG = "*Hi %v,\n" +
		...
		"--------------------------------------------------\n" +
		"❤️Brought to You By @SharkModsOfficial❤️\n*"
